...
public class Config {
    ...
    private static final boolean BASIN_CAPACITY_EXPANSION_ENABLED_DEFAULT = true;
    ...
    public static final ModConfigSpec.BooleanValue BASIN_CAPACITY_EXPANSION_ENABLED = BUILDER
            .comment("Enables basin capacity expansion",
                    "Requires restarting the game to fully apply")
            .translation("fluidlogistics.configuration.basinCapacityExpansionEnabled")
            .define("basinCapacityExpansionEnabled", BASIN_CAPACITY_EXPANSION_ENABLED_DEFAULT);
    ...
    private static boolean basinCapacityExpansionEnabled = BASIN_CAPACITY_EXPANSION_ENABLED_DEFAULT;
    ...
    static void onLoad(final ModConfigEvent event) {
        ...
        basinCapacityExpansionEnabled = BASIN_CAPACITY_EXPANSION_ENABLED.get();
    ...
    public static boolean isBasinCapacityExpansionEnabled() {
